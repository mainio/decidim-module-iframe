  ...
  module Iframe
    class Permissions < Decidim::DefaultPermissions
      def permissions
        ...
        return Decidim::Iframe::Admin::Permissions.new(user, permission_action, context).permissions if permission_action.scope == :admin
      ...
      def editor_image_action?
        ...
        config = context.fetch(:iframe_config, {})
